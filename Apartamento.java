//Classe de Apartamente que é um tipo de locação, contém três atributos diferentes das outras duas classes e seus metodos getters e setters
...
public class Apartamento extends Locacao {
	...
	// Método que retorna informações do apartamento
	@Override
